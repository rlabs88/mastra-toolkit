...
This package is the reusable adapter for RLabs' extended Mastra Code runtime. It projects canonical packages into published Code SDK and TUI APIs without owning the executable process or forking upstream source.
